...
let DistrictModule = exports.DistrictModule = class DistrictModule {
};
exports.DistrictModule = DistrictModule = __decorate([
    (0, common_1.Module)({
        imports: [sequelize_1.SequelizeModule.forFeature([district_model_1.District, region_model_1.Region])],
